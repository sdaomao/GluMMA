 ...
 * Use the {@link CaloriesReport#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CaloriesReport extends Fragment {
     ...
     * @return A new instance of fragment CaloriesReport.
     */
    // TODO: Rename and change types and number of parameters
    public static CaloriesReport newInstance(String param1, String param2) {
        CaloriesReport fragment = new CaloriesReport();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_calories_report, container, false);

        Button StepButton = view.findViewById(R.id.button7);
        StepButton.setOnClickListener(v -> {
            // Do something in response to button click
            Toast.makeText(getActivity(), "Step button clicked", Toast.LENGTH_SHORT).show();
            Fragment fragment = new StepReport();
        ...
        CalorieButton.setOnClickListener(v -> {
            // Do something in response to button click
            Toast.makeText(getActivity(), "You are already in calorie report", Toast.LENGTH_SHORT).show();
        });
    ...
    private void displayWeek() {
        ...
        for (int i = 0; i < dataArray.length(); i++) {
            try {
                ...
                int steps = data.getInt("Calories");
