...
public class Profiler_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profiler_6);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId != -1) {
                    ...
                    startActivity(new Intent(Profiler_6.this, dashboard.class));
                } else {
                    // No radio button is selected, show a message
                    Toast.makeText(Profiler_6.this, "Please select a diabetes type", Toast.LENGTH_SHORT).show();
                }
            }
        });
