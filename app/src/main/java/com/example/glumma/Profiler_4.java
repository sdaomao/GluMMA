...
public class Profiler_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profiler_4);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId != -1) {
                    ...
                    startActivity(new Intent(Profiler_4.this, Profiler_5.class));
                } else {
                    // No radio button is selected, show a message
                    Toast.makeText(Profiler_4.this, "Please select a diabetes type", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        skipButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Profiler_4.this, dashboard.class));
            }
        });
    }
}
