...
public class Profiler_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profiler_3);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId != -1) {
                    ...
                    startActivity(new Intent(Profiler_3.this, Profiler_4.class));
                } else {
                    // No radio button is selected, show a message
                    Toast.makeText(Profiler_3.this, "Please select a diabetes type", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        skipButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Profiler_3.this, dashboard.class));
            }
        });
    }
}
