...
public class Profiler_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profiler_5);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId != -1) {
                    ...
                    startActivity(new Intent(Profiler_5.this, Profiler_6.class));
                } else {
                    // No radio button is selected, show a message
                    Toast.makeText(Profiler_5.this, "Please select a diabetes type", Toast.LENGTH_SHORT).show();
                }
            }
        });
        skipButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Profiler_5.this, dashboard.class));
            }
        });
    }
}
